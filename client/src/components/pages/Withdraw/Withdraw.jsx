...
import { GetAccountDetailsEndpoint, WithdrawCashEndpoint } from "../../../api/url/url"
...
function Withdraw() {
    ...
    async function submitWithdrawForm(e) {
        try {
            ...
            const WithdrawCashApiCallResponse = await Post(WithdrawCashEndpoint, body)
            //setIsSubmmitting(0)
            if (WithdrawCashApiCallResponse.data.status === true) {
                Toast("success", WithdrawCashApiCallResponse.data.message)
                ...
                Toast("error", WithdrawCashApiCallResponse.data.error.message)
            }
        } catch (error) {
            setIsSubmmitting(0)
                    ...
                    <div>
                        <div className='flex justify-between items-center mt-[2rem] px-[2rem] p-[1rem] rounded-[0.5rem] bg-white drop-shadow-md'>
                            ...
                            <div className=' mx-[1rem] '>
                                ...
                                <form onSubmit={submitWithdrawForm} className='my-5'>
