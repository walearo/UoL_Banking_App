...
import { createBankUserEndpoint } from "../../../api/url/url"
...
function BankUser() {
  ...
  async function submitRegisterForm(e) {
    try {
      ...
      const registerApiCallResponse = await Post(createBankUserEndpoint, body)
      setIsSubmmitting(0)
      if (registerApiCallResponse.data.status === true) {
        Toast("success", registerApiCallResponse.data.message)
        const objToSave = {
          email: email
        }
    ...
    <main className='font-Mulish'>
      ...
      <div className='mx-[2rem] flex-col w-[32rem]'>
        <div className='border p-5 w-[28rem] mx-auto drop-shadow-lg rounded-lg'>
          <h2 className='w-[25rem] text-2xl my-4 font-bold'>Register Bank User</h2>
