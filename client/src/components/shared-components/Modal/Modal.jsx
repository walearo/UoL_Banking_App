...
import CloseModalIcon from "../../../img/Svg/CloseModalIcon"

const Modal = ({ title, subtitle, buttonTitle, closeModal }) => {
  return (
    <div className="">
      <div
        className='py-12 bg-transparent backdrop-blur-sm transition duration-150 ease-in-out z-10 absolute top-0 right-0 bottom-0 left-0'
        id='modal'
      >
        <div
          role='alert'
